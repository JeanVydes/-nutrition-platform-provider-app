...
class _MisEmpresasScreenState extends State<MisEmpresasScreen> {
  ...
  Future<void> _cargarEmpresas() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('No se pudieron cargar las empresas: $e'),
  ...
  void _irAAgregarTrabajador(Proveedor empresa) async {
    final result = await Navigator.pushNamed(
      context,
      '/agregar-trabajador',
      arguments: {
              ...
              : RefreshIndicator(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (ctx, i) => _EmpresaCard(
                      ...
                      onAgregarTrabajador: () => _irAAgregarTrabajador(_empresas[i]),
            ...
            children: [
              ...
              if (empresa.ciudad != null || empresa.pais != null)
                _InfoRow(
                  ...
                  text: [empresa.ciudad, empresa.pais]
                      .whereType<String>()
                      .join(', '),
                ),
